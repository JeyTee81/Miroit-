...
class DevisPdfGenerator {
  static pw.Document generateDevis(Devis devis, {Client? client}) {
      ...
      pw.MultiPage(
        ...
        build: (context) => [
          ...
          pw.Row(
            ...
            children: [
              pw.Column(
                ...
                children: [
                  pw.Text('N° Devis: ${devis.numeroDevis ?? "N/A"}', style: pw.TextStyle(fontSize: 14, fontWeight: pw.FontWeight.bold)),
                  pw.SizedBox(height: 8),
                  pw.Text('Date: ${devis.dateCreation != null ? dateFormat.format(devis.dateCreation!) : "N/A"}'),
                  pw.Text('Validité: ${dateFormat.format(devis.dateValidite)}'),
                ],
              ),
              pw.Column(
                ...
                children: [
                  if (devis.remisePourcentage > 0) ...[
                    pw.Row(
                      mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                      children: [
                        pw.Text('Total HT:', style: const pw.TextStyle(fontSize: 10)),
                        pw.Text(currencyFormat.format(devis.montantHt / (1 - devis.remisePourcentage / 100))),
                      ],
                    ),
                    pw.Row(
                      mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                      children: [
                        pw.Text('Remise (${devis.remisePourcentage}%):', style: const pw.TextStyle(fontSize: 10)),
                        pw.Text(currencyFormat.format(devis.montantHt / (1 - devis.remisePourcentage / 100) - devis.montantHt)),
                      ],
                    ),
                  ],
                  pw.Row(
          ...
          if (devis.notes != null && devis.notes!.isNotEmpty) ...[
            ...
            pw.SizedBox(height: 8),
            pw.Text(devis.notes!, style: const pw.TextStyle(fontSize: 10)),
          ],
        ],
      ),
    );
    ...
    return pw.Container(
      ...
      child: pw.Row(
        children: [
          ...
          pw.Expanded(flex: 1, child: pw.Text('Remise', style: pw.TextStyle(fontWeight: pw.FontWeight.bold), textAlign: pw.TextAlign.right)),
  ...
  static pw.Widget _buildTableRow(LigneDevis ligne, NumberFormat currencyFormat) {
    return pw.Container(
      padding: const pw.EdgeInsets.all(8),
      decoration: pw.BoxDecoration(
        border: pw.Border(
      ...
      child: pw.Row(
        children: [
          ...
          pw.Expanded(flex: 1, child: pw.Text('${ligne.remisePourcentage.toStringAsFixed(1)}%', textAlign: pw.TextAlign.right, style: const pw.TextStyle(fontSize: 10))),
